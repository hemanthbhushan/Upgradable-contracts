...
contract OwnedUpgradeabilityProxy {
    ...
    function transferProxyOwnership(address newOwner) public onlyProxyOwner {
        require(newOwner != address(0), "OwnedUpgradeabilityProxy: 1 INVALID");
    ...
    function upgradeToAndCall(address newImplementation, bytes memory data) payable public onlyProxyOwner {
        ...
        require(success, "OwnedUpgradeabilityProxy: 2 INVALID");
    }
    ...
    function _upgradeTo(address newImplementation) internal {
        ...
        require(currentImplementation != newImplementation, "OwnedUpgradeabilityProxy: 3 INVALID");
    ...
    function _fallback() internal {
        ...
        require(_impl != address(0), "OwnedUpgradeabilityProxy: 4 INVALID");
        assembly {
            let ptr := mload(0x40)
